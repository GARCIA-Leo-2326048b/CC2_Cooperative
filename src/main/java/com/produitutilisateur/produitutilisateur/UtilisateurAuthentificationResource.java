...
@Path("/authenticate")
@ApplicationScoped
public class UtilisateurAuthentificationResource {
     ...
     */
    public UtilisateurAuthentificationResource(){}

    /**
     * Constructeur permettant d'initialiser le service avec une interface d'accès aux données
     * @param userRepo objet implémentant l'interface d'accès aux données
     */
    public @Inject UtilisateurAuthentificationResource( UtilisateurRepositoryInterface userRepo ){
        this.auth = new UtilisateurAuthentificationService( userRepo ) ;
    }
